...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/makruf1954/script/refs/heads/main/WEBSOCKET/ws-dropbear
...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/makruf1954/script/refs/heads/main/WEBSOCKET/ws-ovpn.py
chmod +x /usr/local/bin/ws-ovpn

# Installing Service
cat > /etc/systemd/system/ws-ovpn.service << END
[Unit]
Description=Python Proxy Mod By NAIFI PROJECT
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/makruf1954/script/refs/heads/main/WEBSOCKET/ws-stunnel
