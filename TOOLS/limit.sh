#!/bin/bash
REPO="https://raw.githubusercontent.com/makruf1954/script/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://github.com/makruf1954/script/raw/refs/heads/main/TOOLS/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
