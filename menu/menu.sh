...
if check_ip_and_get_info "$IP_VPS"; then
    ...
    echo -e "➥ Hubungi admin ${CYAN}「 ✦ @Azure10 ✦ 」${NC}"
    exit 1
fi
...
echo -e "$COLOR1│ ${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}TROJAN   ${WH}[${COLOR1}Menu${WH}]     ${WH}[${COLOR1}09${WH}]${NC} ${COLOR1}• ${WH}UPDATE   ${WH}[${COLOR1}Menu${WH}]$COLOR1 │ $NC"
...
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ $NC ${WH}Versi Script  ${COLOR1}: ${WH}$(cat /opt/.ver) Latest${NC}$COLOR1"
echo -e "$COLOR1│ $NC ${WH}Project       ${COLOR1}: ${WH}NAIFI PROJECT${NC}$COLOR1"
echo -e "$COLOR1│ $NC ${WH}User          ${COLOR1}: ${WH}$client_name${NC}"
