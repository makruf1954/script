...
show_footer() {
    ...
    echo -e " ${COLOR1}║                  ${WH}• NAIFI PROJECT •                ${COLOR1}║${NC}"
    echo -e " ${COLOR1}╚════════════════════════════════════════════════════╝${NC}"
}
...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/makruf1954/script/refs/heads/main/SLOWDNS/installsl.sh"
...
10 |10) clear ; wget -q https://github.com/makruf1954/script/raw/refs/heads/main/install-ulang-vps && bash install-ulang-vps ;; 
11 |11) clear ; del-exp ;;
00 |0) clear ; menu ;; 
